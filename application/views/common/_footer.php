...
<footer class="footer-wrapper footer-layout1" data-bg-src="<?= base_url() ?>assets/img/bg/bg-shape-4.png">
	<div class="container">
		<div class="footer-top">
			<div class="row align-items-center justify-content-between">
				<div class="col-sm-6 col-md-auto text-center text-sm-start">
					<div class="footer1-logo brand-logo bg-white"><a href="<?= base_url() ?>"><img src="<?= base_url() ?>assets/img/logo.png" alt="Logo" height="100"></a></div>
				</div>
