	...
	<div class="breadcumb-wrapper ">
		...
		<div class="container z-index-common">
			<div class="breadcumb-content">
				<h1 class="breadcumb-title">Ghana Center</h1>
				<div class="breadcumb-menu-wrap">
					<i class="far fa-home-lg"></i>
					<ul class="breadcumb-menu">
						<li><a href="<?= base_url() ?>">Home</a></li>
						<li>Our Center</li>
						<li class="active">Ghana</li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div class="row gx-60 align-items-center">
					...
					<div class="col-lg-6">
						<div class="contact-information mb-30">
							<h2 class="pt-2 mb-10">StemRx at Ghana</h2>
							<div class="row">
								<div class="col-xl-6">
									<h4 class="pt-2 mb-10">Address:</h4>
									<p class="fs-md">
										BMT GHANA & SCA FOUNDATION, GREATER ACCRA HOSPITAL, RIDGE, P.O. BOX GP 473 ACCRA, GHANA
									</p>
								</div>
