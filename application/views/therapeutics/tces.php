	...
	<div class="breadcumb-wrapper ">
		...
		<div class="container z-index-common">
			<div class="breadcumb-content">
				<h1 class="breadcumb-title">Trans Corneal Electrical Stimulation</h1>
				<div class="breadcumb-menu-wrap">
					<i class="far fa-home-lg"></i>
					<ul class="breadcumb-menu">
						<li><a href="<?= base_url() ?>">Home</a></li>
						<li class="active">Trans Corneal Electrical Stimulation</li>
					</ul>
				</div>
			</div>
		</div>
					...
					<div class="service-bar">
						<div class="row justify-content-between gy-4 text-center text-lg-start">
							<div class="col-sm-6 col-lg-3 col-xl-auto">
								...
								<h2 class="h5 mb-0">Trans Corneal Electrical Stimulation</h2>
							</div>
							<!-- 
							<div class="col-sm-6 col-lg-3 col-xl-auto">
	...
	<section class="vs-detail-wrapper space-md-bottom">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="">
						<h2 class="h1">Trans Corneal Electrical Stimulation</h2>
						<p class="fs-md mb-4 pb-2">
							Trans Corneal Electrical Stimulation (TCES) at StemRx Hospital involves delivering electrical currents to the retina through the cornea. During the procedure, electrodes are placed on the cornea, and controlled electrical impulses are applied to stimulate retinal cells. TCES promotes retinal cell survival and function, making it a promising therapy for various retinal disorders.
						</p>
					</div>
				</div>
			</div>
			<div class="row mb-md-4 mb-3">
				<div class="col-12">
					...
					<div class="desc mb-3">
						<p>
							TCES at StemRx Hospital is utilized in the treatment of retinal disorders such as retinitis pigmentosa and macular degeneration. It is also used in research settings to study retinal function and explore potential therapeutic interventions for other eye-related conditions. Patients undergoing TCES experience improved visual acuity and enhanced retinal function.
						</p>
					</div>
				</div>
			</div>
			...
			<div class="row mb-md-4 mb-3">
				<div class="col-12">
					...
					<div class="desc mb-3">
						<p>
							Compared to conventional treatments, TCES at StemRx Hospital offers several advantages. Firstly, it provides targeted stimulation to the retina, promoting retinal cell survival and function. This leads to improved visual acuity and enhanced quality of life for patients with retinal disorders. Additionally, TCES is non-invasive and generally well-tolerated, with minimal side effects reported. It also offers the potential for long-term benefits, as repeated treatments can lead to sustained improvements in visual function. Moreover, TCES can be customized to target specific areas of the retina, ensuring personalized treatment plans tailored to each patient's needs. Overall, TCES at StemRx Hospital represents a promising and innovative approach to treating retinal disorders, offering personalized and effective therapeutic interventions.
						</p>
					</div>
				</div>
			</div>
