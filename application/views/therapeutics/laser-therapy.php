	...
	<div class="breadcumb-wrapper ">
		...
		<div class="container z-index-common">
			<div class="breadcumb-content">
				<h1 class="breadcumb-title">Laser Therapy</h1>
				<div class="breadcumb-menu-wrap">
					<i class="far fa-home-lg"></i>
					<ul class="breadcumb-menu">
						<li><a href="<?= base_url() ?>">Home</a></li>
						<li class="active">Laser Therapy</li>
					</ul>
				</div>
			</div>
		</div>
					...
					<div class="service-bar">
						<div class="row justify-content-between gy-4 text-center text-lg-start">
							<div class="col-sm-6 col-lg-3 col-xl-auto">
								...
								<h2 class="h5 mb-0">Laser Therapy</h2>
							</div>
							<!-- 
							<div class="col-sm-6 col-lg-3 col-xl-auto">
	...
	<section class="vs-detail-wrapper space-md-bottom">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="">
						<h2 class="h1">Laser Therapy</h2>
						<p class="fs-md mb-4 pb-2">
							<strong>Laser Therapy </strong> at StemRx Hospital utilizes specific wavelengths of light to penetrate the skin and stimulate cellular regeneration and repair. During the procedure, a handheld laser device is applied to the affected area, delivering controlled pulses of light energy. This promotes tissue healing, reduces inflammation, and alleviates pain..
						</p>
					</div>
				</div>
			</div>
			<div class="row mb-md-4 mb-3">
				<div class="col-12">
					...
					<div class="desc mb-3">
						<p>
							Laser Therapy at StemRx Hospital is applied for various musculoskeletal conditions such as arthritis, tendonitis, and sports injuries. It is also effective in promoting wound healing and reducing scar tissue formation. Patients undergoing Laser Therapy experience targeted pain relief and accelerated recovery.
						</p>
					</div>
				</div>
			</div>
			...
			<div class="row mb-md-4 mb-3">
				<div class="col-12">
					...
					<div class="desc mb-3">
						<p>
							Compared to conventional treatments, Laser Therapy at StemRx Hospital offers several advantages. Firstly, it provides targeted pain relief without the need for medications or invasive procedures, reducing the risk of side effects and complications. Additionally, Laser Therapy stimulates cellular repair and regeneration at the source, leading to faster healing and improved outcomes. Unlike surgical interventions, Laser Therapy is non-invasive and does not require downtime, allowing patients to resume normal activities promptly. Moreover, Laser Therapy can be precisely adjusted to target specific areas, ensuring personalized treatment tailored to each patient's needs. Overall, Laser Therapy at StemRx Hospital offers a safe, effective, and minimally invasive approach to pain management and tissue repair.
						</p>
					</div>
				</div>
			</div>
