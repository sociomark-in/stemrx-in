	...
	<div class="breadcumb-wrapper">
		...
		<div class="container z-index-common">
			<div class="breadcumb-content">
				<h1 class="breadcumb-title">Dvelopmental Problem </h1>
				<div class="breadcumb-menu-wrap"><i class="far fa-home-lg"></i>
					<ul class="breadcumb-menu">
						<li><a href="index-2.html">Home</a></li>
						<li class="active">Dvelopmental Problem </li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row text-center justify-content-center mb-30">
				<div class="col-12 wow fadeInUp" data-wow-delay="0.3s">
					<h2 class="h1">All Dvelopmental Problem Conditions</h2>
				...
				<div class="col-2">
						...
						<div class="col-2">
							<a href="#" class="text-center">
								...
								<h6 class="text-theme">Cerebral Palsy (muscle-related symptoms)</h6>
							</a>
						</div>
						<div class="col-2">
							<a href="#" class="text-center">
						...
						<div class="col-2">
							<a href="#" class="text-center">
								...
								<h6 class="text-theme">Autism Spectrum Disorders (ASD)</h6>
							</a>
						</div>
						<div class="col-2">
							<a href="#" class="text-center">
								...
								<h6 class="text-theme">Attention Deficit/ Hyperactivity Disorder (ADHD)</h6>
							</a>
						</div>
				</div>
			</div>
