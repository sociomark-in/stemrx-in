	...
	<div class="breadcumb-wrapper ">
		...
		<div class="container z-index-common">
			<div class="breadcumb-content">
				<h1 class="breadcumb-title">Neurogenetic Disorder</h1>
				<div class="breadcumb-menu-wrap">
					<i class="far fa-home-lg"></i>
					<ul class="breadcumb-menu">
						<li><a href="<?= base_url(); ?>">Home</a></li>
						<li class="active">Neurogenetic Disorder</li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div class="col-12">
					<div class="service-content mb-30">
						<div class="vs-surface wow" data-wow-delay="0.3s">
							<picture>
								<source media="(min-width: 800px)" srcset="<?= base_url("assets/") ?>img/banners/conditions/neurogenetic-disorders_1200x600.webp" type="image/webp">
								<source media="(min-width: 800px)" srcset="<?= base_url("assets/") ?>img/banners/conditions/neurogenetic-disorders_1200x600.jpg" type="image/jpg">
								<source srcset="<?= base_url("assets/") ?>img/banners/conditions/neurogenetic-disorders_800x800.jpg" type="image/webp">
								<img src="<?= base_url("assets/") ?>img/banners/conditions/neurogenetic-disorders_800x800.jpg" alt="Service Image" class="w-100">
							</picture>
						</div>
