	...
	<div class="breadcumb-wrapper">
		...
		<div class="container z-index-common">
			<div class="breadcumb-content">
				<h1 class="breadcumb-title">Cosmetic Treatment </h1>
				<div class="breadcumb-menu-wrap"><i class="far fa-home-lg"></i>
					<ul class="breadcumb-menu">
						<li><a href="#">Home</a></li>
						<li class="active">Cosmetic Treatment</li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row text-center justify-content-center mb-30">
				<div class="col-12 wow fadeInUp" data-wow-delay="0.3s">
					<h2 class="h1">All Cosmetic Treatment Conditions</h2>
				...
				<div class="row justify-content-center">
						...
						<a href="#" class="text-center">
							<div class="card bg-white sp-item mb-2">
								<div class="card-body p-5">
									<img src="<?= base_url("assets/img/icons/color/diseases/acne.png") ?>" alt="Acne " class="w-100">
								</div>
							</div>
					...
					<div class="col-lg-2 col-md-4 col-6">
						<a href="#" class="text-center">
							<div class="card bg-white sp-item mb-2">
								<div class="card-body p-5">
									<img src="<?= base_url("assets/img/icons/color/diseases/no-scars.png") ?>" alt="Scar Revision " class="w-100">
								</div>
							</div>
