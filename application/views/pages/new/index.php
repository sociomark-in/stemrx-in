<main>
	<section class="vs-hero-wrapper position-relative">
		<div class="vs-hero-carousel" data-navprevnext="true" data-height="800" data-container="1900" data-slidertype="responsive">
			<div class="ls-slide" data-ls="duration: 13000; transition2d: 5;"><img src="<?= base_url() ?>assets/img/hero/infertility.jpeg" alt="infertility" class="ls-bg">
				...
				<div class="ls-btn ls-l ls-responsive" data-ls-mobile="left: 100px; " data-ls-tablet="left: 100px; top: 580px;" data-ls-laptop="left: 100px; top: 580px;" style="left: 335px; top: 518px;" data-ls="offsetyin: 200; durationin: 2000; delayin: 1400; offsetyout: 300; durationout: 2000; offsetyout: 100; durationout: 2000; "><a href="<?= base_url() ?>en/service" class="vs-btn style3 hover-white">View All Services<i class="fas fa-bolt"></i></a></div> -->
			</div>
			<div class="ls-slide" data-ls="duration: 13000; transition2d: 5;"><img src="<?= base_url() ?>assets/img/hero/pain-relif.jpeg" alt="pain-relif" class="ls-bg">
				<!-- <div class="ls-slide" data-ls="duration: 13000; transition2d: 5;"><img src="<?= base_url() ?>assets/img/hero/h-bg-1-1-ph.jpg" alt="pain-relif" class="ls-bg"> -->
				...
				<?php for ($i = 0; $i < 4; $i++) : ?>
					<div class="col-xl-4 mb-25">
						<div class="service-box">
							...
							<div class="sr-content">
								<h3 class="h4"><a class="text-reset" href="<?= base_url() ?>en/service">Hairfall</a></h3>
								<p class="fs-xs">Continually evisculate goal-oriented portals rather than prospective channels. excellent customize life</p>
							</div><a href="<?= base_url() ?>en/service" class="icon-btn style4"><i class="far fa-long-arrow-alt-right"></i></a>
						</div>
					</div>
					<div class="col-xl-4 mb-25">
						<div class="service-box">
							...
							<div class="sr-content">
								<h3 class="h4"><a class="text-reset" href="<?= base_url() ?>en/service">Infertility</a></h3>
								<p class="fs-xs">Continually evisculate goal-oriented portals rather than prospective channels. excellent customize life</p>
							</div><a href="<?= base_url() ?>en/service" class="icon-btn style4"><i class="far fa-long-arrow-alt-right"></i></a>
						</div>
					</div>
					<div class="col-xl-4 mb-25">
						<div class="service-box">
							...
							<div class="sr-content">
								<h3 class="h4"><a class="text-reset" href="<?= base_url() ?>en/service">Cosmatics Gynecology</a></h3>
								<p class="fs-xs">Continually evisculate goal-oriented portals rather than prospective channels. excellent customize life</p>
							</div><a href="<?= base_url() ?>en/service" class="icon-btn style4"><i class="far fa-long-arrow-alt-right"></i></a>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-12">
					<div class="text-center">
						<a href="" class="vs-btn">View More Treatments</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row justify-content-center">
				<div class="col-lg-9 col-md-11 col-12">
					<div class="row g-4">
						...
						<div class="col-12">
							<div class="text-center">
								<a href="" class="vs-btn">View More</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="wow fadeInUp" data-wow-delay="0.3s">
					<div class="row vs-carousel text-center" data-slide-show="5" data-lg-slide-show="4" data-md-slide-show="3" data-sm-slide-show="3" data-xs-slide-show="1">
						<div class="col-auto">
							<div class="brand"><img src="<?= base_url() ?>assets/img/brand/brand-1-1.svg" alt="Brand Image"></div>
						</div>
						<div class="col-auto">
							<div class="brand"><img src="<?= base_url() ?>assets/img/brand/brand-1-2.svg" alt="Brand Image"></div>
						</div>
						<div class="col-auto">
							<div class="brand"><img src="<?= base_url() ?>assets/img/brand/brand-1-3.svg" alt="Brand Image"></div>
						</div>
						<div class="col-auto">
							<div class="brand"><img src="<?= base_url() ?>assets/img/brand/brand-1-4.svg" alt="Brand Image"></div>
						</div>
						<div class="col-auto">
							<div class="brand"><img src="<?= base_url() ?>assets/img/brand/brand-1-5.svg" alt="Brand Image"></div>
						</div>
						<div class="col-auto">
							<div class="brand"><img src="<?= base_url() ?>assets/img/brand/brand-1-6.svg" alt="Brand Image"></div>
						</div>
					</div>
				</div>
			</div>
	...
	<section class="vs-project-wrapper position-relative space-top pb-50" data-bg-color="#f9f9f9">
		...
		<div class="row">
			<div class="col-12">
				<div class="text-center">
					<a href="" class="vs-btn">View All Doctors</a>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="row">
					<div class="col-lg-6 col-xl-6 mb-30 mb-lg-0">
						<div class="vs-middle-box d-md-flex text-center text-md-start bg-theme">
							<div class="media-icon mb-20 mb-md-0 mr-20"><img src="<?= base_url() ?>assets/img/icons/icon-1-1.png" alt="Icon"></div>
			...
			<div class="row vs-carousel wow fadeInUp" data-wow-delay="0.3s" data-slide-show="3" data-lg-slide-show="2">
				<div class="col-xl-4">
					<div class="vs-blog blog-card">
						<div class="blog-img"><img src="<?= base_url() ?>assets/img/blog/b-1-1.jpg" alt="Blog Image" class="w-100">
							<div class="blog-date">
								<div class="day">22</div>Jan 2023
							</div>
						</div>
						<div class="blog-content">
							<div class="blog-meta"><a href="<?= base_url() ?>en/blog"><i class="far fa-folder"></i>Mental Health</a> <a href="<?= base_url() ?>en/blog"><i class="fal fa-user"></i>David Smith</a></div>
							<h3 class="blog-title h5 font-body lh-base"><a href="<?= base_url() ?>en/blog">Services enable process is tobe after user-centric schemas now</a></h3><a href="<?= base_url() ?>en/blog" class="link-btn">Read More<i class="far fa-long-arrow-right"></i></a>
						</div>
					</div>
				</div>
				<div class="col-xl-4">
					<div class="vs-blog blog-card">
						<div class="blog-img"><img src="<?= base_url() ?>assets/img/blog/b-1-2.jpg" alt="Blog Image" class="w-100">
							<div class="blog-date">
								<div class="day">23</div>Mar 2023
							</div>
						</div>
						<div class="blog-content">
							<div class="blog-meta"><a href="<?= base_url() ?>en/blog"><i class="far fa-folder"></i>Therapy</a> <a href="<?= base_url() ?>en/blog"><i class="fal fa-user"></i>Vivi Marian</a></div>
							<h3 class="blog-title h5 font-body lh-base"><a href="<?= base_url() ?>en/blog">From its medieval origins to the digital era everything there</a></h3><a href="<?= base_url() ?>en/blog" class="link-btn">Read More<i class="far fa-long-arrow-right"></i></a>
						</div>
					</div>
				</div>
				<div class="col-xl-4">
					<div class="vs-blog blog-card">
						<div class="blog-img"><img src="<?= base_url() ?>assets/img/blog/b-1-3.jpg" alt="Blog Image" class="w-100">
							<div class="blog-date">
								<div class="day">28</div>Dec 2023
							</div>
						</div>
						<div class="blog-content">
							<div class="blog-meta"><a href="<?= base_url() ?>en/blog"><i class="far fa-folder"></i>Acupressure </a><a href="<?= base_url() ?>en/blog"><i class="fal fa-user"></i>Moris John</a></div>
							<h3 class="blog-title h5 font-body lh-base"><a href="<?= base_url() ?>en/blog">Latin derived from Cicero's 1st-century BC text De Fini now with</a></h3><a href="<?= base_url() ?>en/blog" class="link-btn">Read More<i class="far fa-long-arrow-right"></i></a>
						</div>
					</div>
				</div>
				<div class="col-xl-4">
					<div class="vs-blog blog-card">
						<div class="blog-img"><img src="<?= base_url() ?>assets/img/blog/b-1-4.jpg" alt="Blog Image" class="w-100">
							<div class="blog-date">
								<div class="day">22</div>Jan 2023
							</div>
						</div>
						<div class="blog-content">
							<div class="blog-meta"><a href="<?= base_url() ?>en/blog"><i class="far fa-folder"></i>Mental Health</a> <a href="<?= base_url() ?>en/blog"><i class="fal fa-user"></i>David Smith</a></div>
							<h3 class="blog-title h5 font-body lh-base"><a href="<?= base_url() ?>en/blog">Creation timelines the standard lorem ipsum passage vary</a></h3><a href="<?= base_url() ?>en/blog" class="link-btn">Read More<i class="far fa-long-arrow-right"></i></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-12">
					<div class="vs-accordion accordion accordion-style2" id="vs-faq-accordion">
						<div class="accordion-item">
							<h2 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="false" aria-controls="collapse1">Uniquely optimize reliable models before wireless results ofessionally impact progressive core.</button></h2>
						...
						<div class="accordion-item">
							<h2 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse3" aria-expanded="false" aria-controls="collapse3">From its medieval origins to the digital era, learn everything there is to know about the ubiquitous</button></h2>
