					...
					<tbody>
						<tr class="cart_item">
							<td data-title="Product">
								<a class="cart-productimage" href="#"><img width="91" height="91" src="<?= base_url() ?>assets/img/product/cart-1.jpg" alt="Image" /></a>
							</td>
							<td data-title="Name">
						...
						<tr class="cart_item">
							<td data-title="Product">
								<a class="cart-productimage" href="#"><img width="91" height="91" src="<?= base_url() ?>assets/img/product/cart-2.jpg" alt="Image" /></a>
							</td>
							<td data-title="Name">
						...
						<tr class="cart_item">
							<td data-title="Product">
								<a class="cart-productimage" href="#"><img width="91" height="91" src="<?= base_url() ?>assets/img/product/cart-3.jpg" alt="Image" /></a>
							</td>
							<td data-title="Name">
						...
						<tr>
							<td colspan="6" class="actions">
								<div class="vs-cart-coupon">
									...
									<button type="submit" class="vs-btn rounded-1 shadow-none">
										Apply Coupon
									</button>
								</div>
								<button type="submit" class="vs-btn rounded-1 shadow-none">
								...
								<td data-title="Shipping and Handling">
									...
									<form action="#" method="post">
										...
										<div class="shipping-calculator-form">
											...
											<p>
												<button class="vs-btn shadow-none rounded-1">
													Update
												</button>
											</p>
										</div>
