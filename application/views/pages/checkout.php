		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4">
					<form action="#" class="woocommerce-form-login">
						...
						<div class="form-group"><button type="submit" class="vs-btn shadow-none">Login</button>
			...
			<div class="row">
				<div class="col-lg-4">
					<form action="#" class="woocommerce-form-coupon">
						...
						<div class="form-group"><button type="submit" class="vs-btn shadow-none">Apply coupon</button></div>
					</form>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-6">
						...
						<div class="row">
							...
							<div class="col-12 form-group"><input type="checkbox" id="accountNewCreate"> <label for="accountNewCreate">Creat An Account?</label></div>
						</div>
					</div>
					<div class="col-lg-6">
						<p id="ship-to-different-address"><input id="ship-to-different-address-checkbox" type="checkbox" name="ship_to_different_address" value="1"> <label for="ship-to-different-address-checkbox">Ship to a different address? <span class="checkmark"></span></label></p>
			...
			<form action="#" class="woocommerce-cart-form">
				<table class="cart_table mb-20">
					...
					<tbody>
						<tr class="cart_item">
							<td data-title="Product"><a class="cart-productimage" href="#"><img width="91" height="91" src="<?= base_url() ?>assets/img/product/cart-1.jpg" alt="Image"></a></td>
							<td data-title="Name"><a class="cart-productname" href="#">Kevzara</a></td>
			...
			<div class="mt-lg-3 mb-30">
				<div class="woocommerce-checkout-payment">
					<ul class="wc_payment_methods payment_methods methods">
						...
						<li class="wc_payment_method payment_method_cod"><input id="payment_method_cod" type="radio" class="input-radio" name="payment_method"> <label for="payment_method_cod">Credit Cart <img src="<?= base_url() ?>assets/img/cart/all.jpg" alt="image"></label>
							<div class="payment_box payment_method_cod">
								<p>Pay with cash upon delivery.</p>
							</div>
						</li>
						<li class="wc_payment_method payment_method_paypal"><input id="payment_method_paypal" type="radio" class="input-radio" name="payment_method" value="paypal"> <label for="payment_method_paypal">Paypal<img src="<?= base_url() ?>assets/img/cart/paypal.jpg" alt="PayPal acceptance mark"></label>
